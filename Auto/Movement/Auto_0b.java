...
@Autonomous(name = "Pre-Auto b") // pos b = farther from backdrop
public class Auto_0b extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            moveForward(power, (int)(trm.getCurrentPosition() + COUNTS_PER_INCH * 104));
