...
@Autonomous(name = " Updated Blue Alliance Pos 1") // closer to the backdrop
public class updatedAutoBlue extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            // place pixel
            // moveLeft(power, (int)(trm.getCurrentPosition() + COUNTS_PER_INCH * 40));
...
//        resetMotors();
    ...
    public void moveRight(double power, int dist) {
        ...
        telemetry.addLine("inside right function ");
