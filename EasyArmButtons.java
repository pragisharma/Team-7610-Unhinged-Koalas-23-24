...
public class EasyArmButtons extends LinearOpMode {
    ...
    final double SECOND_ALPHA_ANGLE = STORAGE_ALPHA_ANGLE + 87;
    final int SECOND_BETA_TICKS = 785;

    final double THIRD_ALPHA_ANGLE = STORAGE_ALPHA_ANGLE + 96;
    final int THIRD_BETA_TICKS = 1060;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            /*
            if (gamepad2.dpad_up) {
                maxArmPower += (maxArmPower >= 1) ? 0 : 0.05;
            } else if (gamepad2.dpad_down) {
                maxArmPower -= (maxArmPower <= 0) ? 0 : 0.05;
            }
             */
