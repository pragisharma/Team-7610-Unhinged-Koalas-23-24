...
import static org.firstinspires.ftc.teamcode.Auto.Final.CloseBlue2.ArmStates.*;
...
@Autonomous(name = "blue close two") // closer to the backdrop
public class CloseBlue2 extends LinearOpMode {
    ...
    public void endOutput(int deg){
        turn(power, deg);
        sleep(20);
        moveRight(power, (int)(-(trm.getCurrentPosition() + COUNTS_PER_INCH * 36)));
        sleep(20);
